          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <h2 className="text-lg font-semibold text-gray-900 mb-4">Основни характеристики</h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xl font-bold text-gray-900">{area} м²</div>
                  ...
                  {rooms && (
                    <div className="text-center">
                      ...
                      <div className="text-xl font-bold text-gray-900">{rooms}</div>
                  ...
                  {floor && (
                    <div className="text-center">
                      ...
                      <div className="text-xl font-bold text-gray-900">{floor} / {totalFloors}</div>
              ...
              {features && features.length > 0 && (
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-4">Удобства и екстри</h2>
              ...
              <div className="sticky top-24 space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <a
                      href={`mailto:info@imoti-direct.com?subject=Запитване за: ${title}`}
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                  ...
                  <div className="flex space-x-3">
                    ...
                    <button className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600 hover:bg-green-500 hover:text-white transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <button className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600 hover:bg-gray-700 hover:text-white transition-colors">
