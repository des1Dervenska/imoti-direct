      ...
      <section className="bg-gray-100 py-4">
        <div className="max-w-screen-xl mx-auto px-4">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-[#495464] font-medium truncate max-w-xs">{title}</span>
          </nav>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="lg:hidden">
                ...
                <h1 className="text-2xl font-bold text-[#495464] mb-3">{title}</h1>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <h2 className="text-lg font-semibold text-[#495464] mb-4">Основни характеристики</h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xl font-bold text-[#495464]">{area} м²</div>
                  ...
                  {rooms && (
                    <div className="text-center">
                      ...
                      <div className="text-xl font-bold text-[#495464]">{rooms}</div>
                  ...
                  {floor && (
                    <div className="text-center">
                      ...
                      <div className="text-xl font-bold text-[#495464]">{floor} / {totalFloors}</div>
                  ...
                  {yearBuilt && (
                    <div className="text-center">
                      ...
                      <div className="text-xl font-bold text-[#495464]">{yearBuilt}</div>
              ...
              {/* Description */}
              <div>
                <h2 className="text-xl font-semibold text-[#495464] mb-4">Описание</h2>
                <div className="prose prose-gray max-w-none">
                  <p className="text-[#6b7a8f] leading-relaxed whitespace-pre-line">
                    {description}
                  </p>
                </div>
              </div>
              ...
              {features && features.length > 0 && (
                <div>
                  <h2 className="text-xl font-semibold text-[#495464] mb-4">Удобства и екстри</h2>
              ...
              {/* Location */}
              <div>
                <h2 className="text-xl font-semibold text-[#495464] mb-4">Местоположение</h2>
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-start space-x-3 mb-4">
                    ...
                    <div>
                      <p className="font-medium text-[#495464]">{address}</p>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                ...
                <div className="hidden lg:block bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                  ...
                  <h1 className="text-xl font-bold text-[#495464] mb-4">{title}</h1>
                ...
                <div className="bg-[#495464]/5 border border-[#495464]/10 rounded-2xl p-6">
                  <h3 className="text-lg font-semibold text-[#495464] mb-4">
                    Свържете се с нас
                  </h3>
                  ...
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                      <p className="font-semibold text-[#495464]">{CONTACT_PERSON}</p>
                  ...
                  <div className="space-y-3">
                    <a
                      ...
                      className="flex items-center justify-center w-full px-4 py-3 bg-[cadetblue] hover:bg-[#4a8a8c] text-white font-medium rounded-lg transition-colors"
                    >
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                  <h3 className="text-sm font-semibold text-[#495464] mb-3">
                    Сподели обявата
                  </h3>
                  <div className="flex space-x-3">
                    <button className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-[#6b7a8f] hover:bg-[#495464] hover:text-white transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z"/>
                      </svg>
                    </button>
                    <button className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-[#6b7a8f] hover:bg-[#6b7a8f] hover:text-white transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                      </svg>
                    </button>
                    <button className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-[#6b7a8f] hover:bg-green-500 hover:text-white transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <button className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-[#6b7a8f] hover:bg-gray-700 hover:text-white transition-colors">
