            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-8 pt-8 border-t">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-gray-200 rounded-lg flex items-center justify-center text-gray-600 hover:bg-blue-600 hover:text-white transition-colors">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <p className="text-sm text-gray-500">
                    ...
                    <a href="#" className="text-blue-600 hover:underline">политика за поверителност</a>.
                  </p>

                  {/* Submit Button */}
                  <button
                    type="submit"
                    className="w-full md:w-auto px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors focus:ring-4 focus:ring-blue-300 flex items-center justify-center"
                  >
