...
export const metadata = {
  title: "За нас | Имоти Директ",
  description: "Научете повече за Имоти Директ - вашият надежден партньор в света на недвижимите имоти с над 15 години опит.",
};
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Имоти Директ - повече от 15 години на пазара
              </h2>
              <div className="space-y-4 text-gray-600">
                <p>
                  <strong className="text-gray-900">Имоти Директ</strong> е агенция за недвижими имоти, основана през 2009 година в София. От самото начало нашата мисия е да предоставяме професионални и надеждни услуги в сферата на недвижимите имоти.
                </p>
                <p>
