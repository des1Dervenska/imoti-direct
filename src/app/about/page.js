        ...
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="mt-8 p-6 bg-[#495464]/5 rounded-xl">
                <div className="flex items-center space-x-4">
                  <div className="w-16 h-16 bg-[#495464]/10 rounded-full flex items-center justify-center">
        ...
        <div className="max-w-screen-xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <div className="w-12 h-12 bg-[#495464]/10 rounded-lg flex items-center justify-center mb-4">
